...
| **Regression coverage** | **1,261 tests across 62 files** (17 Aug 2026). Every finding in PROJECT_ASSESSMENT that was fixed has a test that fails if it regresses — which is the property that matters more than the count. |
