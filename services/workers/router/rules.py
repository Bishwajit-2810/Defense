...
CONFIDENCE_THRESHOLD: float = float(os.getenv("ROUTER_CONFIDENCE_THRESHOLD", "0.65"))
POST_TYPE_CONFIDENCE_THRESHOLD: float = float(
    os.getenv("ROUTER_POST_TYPE_CONFIDENCE_THRESHOLD", "0.65")
)
TOXICITY_THRESHOLD: float = float(os.getenv("ROUTER_TOXICITY_THRESHOLD", "0.7"))
LONG_TEXT_CHARS: int = int(os.getenv("ROUTER_LONG_TEXT_CHARS", "1500"))
