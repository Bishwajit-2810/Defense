...
from defense.services.api.deps import get_current_user, get_db, get_redis, tenant_is_privacy_locked

from defense.libs import sentiment_models
...
def _models() -> dict:
    ...
    """
    from defense.libs.llm.client import VALID_ROLES, LLMClient  # noqa: PLC0415
...
async def _current(redis: aioredis.Redis) -> dict:
    default_backend = get_settings().llm_backend
